...
class PokemonQuerySet():
  ...
  def _get_sql_query(self):
    ...
    query_columns = {
      ...
      "gh_1"  : {"type": "string"},
      "gh_2"  : {"type": "string"},
      "poder" : {"type": "fuzzy", "subtype_converter": int},
      "region": {"type": "string"},
      "ratio" : {"type": "fuzzy", "subtype_converter": int},
      "color" : {"type": "string"}
      }
...
class Pokemon(object):
  ...
  def __init__(self, codigo, nombre, tipo_1, tipo_2, gh_1, gh_2, poder, region, ratio, color):
    self.codigo = codigo
    self.nombre = nombre
    self.tipo_1 = tipo_1
    self.tipo_2 = tipo_2
